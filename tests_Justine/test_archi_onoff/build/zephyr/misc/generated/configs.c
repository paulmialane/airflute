...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BLE_MIDI, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BLE_MIDI_TX_PACKET_MAX_SIZE, 244);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BLE_MIDI_TX_MODE_SINGLE_MSG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BLE_MIDI_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BLE_MIDI_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_TEST_ARCHI_ONOFF_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_XIAO_BLE_NRF52840_SENSE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOOT_DELAY, 5000);
