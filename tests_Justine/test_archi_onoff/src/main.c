...
K_THREAD_DEFINE(triggerChangeId, STACKSIZE, triggerChangeThreadInit, NULL, NULL, NULL, PRIORITY, 0, 0);
K_THREAD_DEFINE(transformMidiId, STACKSIZE, transformMidiThreadInit, NULL, NULL, NULL, PRIORITY, 0, 0);
