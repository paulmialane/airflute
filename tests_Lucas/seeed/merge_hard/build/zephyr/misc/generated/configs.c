...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_PCF857X_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GPIO_PCF857X, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GPIO_PCF857X_INIT_PRIORITY, 70);
